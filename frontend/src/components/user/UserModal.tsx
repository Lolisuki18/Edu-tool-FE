          ...
          <div className="space-y-5">
            {action == USER_ACTION.VIEW && (
              <div className="group space-y-1.5 animate-in slide-in-from-top-4 duration-500">
                <label
                  htmlFor="userId"
                  className="text-body font-medium ml-1 tracking-wide transition-colors text-primary"
                >
                ...
                <div className="w-full px-4 py-3 bg-background border border-border rounded-xl focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary transition-all flex items-center gap-3">
                  <Grid3x3Icon fontSize="small" className="text-primary flex-shrink-0" />
                  <input
                    id="userId"
                    name="userId"
                    required
              ...
              <div className="group space-y-1.5 animate-in slide-in-from-top-4 duration-500">
                ...
                <div className="w-full px-4 py-3 bg-background border border-border rounded-xl focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary transition-all flex items-center gap-3">
                  ...
                  <input
                    ...
                    name="username"
                    required
                    readOnly={action === USER_ACTION.VIEW}
                    className="flex-1 bg-transparent border-none outline-none text-text-primary placeholder:text-secondary font-medium"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <CustomSelect
                ...
                disabled={action === USER_ACTION.VIEW}
              />
              <CustomSelect
                label="Trạng thái"
                name="status"
                ...
                disabled={action !== USER_ACTION.UPDATE}
              />
            </div>
